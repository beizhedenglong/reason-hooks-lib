...
Jest.describe("useCounter", (function (param) {
        ...
        return Jest.test("count is 2", (function (param) {
                      ReactHooks.act((function () {
                              return Curry._1(container.result.current[/* set */1], (function (prev) {
                                            return prev + 1 | 0;
                                          }));
...
Jest.describe("createStore", (function (param) {
        var match = State$ReasonHooksLib.createStore(/* record */[
              /* name */"victor",
              /* age */21
            ]);
        var getState = match[/* getState */1];
        var useStore = match[/* useStore */0];
        var container = ReactHooks.renderHook((function (param) {
                return Curry._1(useStore, /* () */0);
              }), undefined);
